...
export default function DetailedGraphPage() {
  ...
  const graphData = useMemo(() => {
    ...
    const unique_ids = [...new Set(node_ids)].filter(
      (id) => id !== main_node.id,
    );
    ...
    <main className="h-screen w-screen overflow-hidden bg-[#1E1E1E] flex flex-col">
      ...
      <header className="bg-[#1E1E1E] text-white flex items-center justify-between px-4 sm:px-6 lg:px-10 py-4 lg:py-6 flex-shrink-0">
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <h1
            className={
              ...
              " text-[#DFDEDE] text-lg lg:text-xl font-semibold tracking-widest hidden sm:block"
            }
          >
            UPB Network Diagram
          </h1>
          <h1
            className={
              juliusSansOne.className +
              " text-[#DFDEDE] text-sm font-semibold tracking-widest sm:hidden"
            }
          >
            UPB Network
          </h1>
        ...
        <div className="relative group">
          <Button
            ...
            className={
              juliusSansOne.className +
              " hover:bg-stone-400/30 hover:text-[#DFDEDE] px-2 py-1 rounded-sm text-xs sm:text-sm"
            }
          >
        ...
        <div className="flex-shrink-0 px-4 sm:px-6 lg:px-10 py-4 lg:py-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-start gap-2 w-full mb-2 sm:mb-4">
            <h6
              className={
                juliusSansOne.className +
                " text-xs font-bold rounded-md py-1 px-2 bg-[#D9D9D9] text-black whitespace-nowrap"
              }
            >
              Detailed Node View:
            </h6>
            {previousNodeLabel && (
              <Button
                ...
                className={
                  juliusSansOne.className +
                  " hover:text-gray-400 text-gray-800 px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm h-auto"
                }
              >
          ...
          <h2
            className={
              juliusSansOne.className +
              " text-2xl sm:text-3xl lg:text-4xl text-[#476A99] break-words"
            }
          >
            {currentNodeLabel}
          </h2>
      ...
      <div className="fixed bottom-2 sm:bottom-5 left-2 sm:left-5 lg:left-20 text-xs bg-white p-2 rounded shadow max-w-[200px] sm:max-w-xs text-left max-h-24 sm:max-h-32 flex flex-col overflow-hidden z-10">
        <div
          className={
            raleway.className +
            " font-bold p-1 sm:p-2 bg-white border-b sticky top-0 z-10 text-xs"
          }
        >
